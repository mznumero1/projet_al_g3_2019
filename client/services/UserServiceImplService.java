 ...
 * 
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://services/", wsdlLocation = "http://localhost:8080/ws/soap?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/ws/soap?wsdl");
